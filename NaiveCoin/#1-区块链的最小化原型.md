...
![changeBlock](../images/coin_#1_img_2.png)  
...
![longerchain](../images/coin_#1_img_3.png)
...
![networkrule](../images/coin_#1_img_4.png)
...
```
#### Architecture
应该注意，节点实际上暴露了两个Web服务器：一个用于用户控制节点（HTTP服务器），一个用于节点之间的对等通信（Websocket HTTP服务器）。
![networklink](../images/coin_#1_img_5.png)
